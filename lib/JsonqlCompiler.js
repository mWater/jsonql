...
module.exports = JsonqlCompiler = (function() {
  ...
  JsonqlCompiler.prototype.compileOpExpr = function(expr, aliases) {
    ...
    functions = ["avg", "min", "max", "sum", "count", "stdev", "stdevp", "var", "varp", "row_number", "left", "right", "substr", "lpad", "rpad", "width_bucket", "ntile", "coalesce", "to_json", "convert_to_decimal", "json_build_array", "json_build_object", "json_object", "json_array_elements", "jsonb_array_elements", "json_array_elements_text", "jsonb_array_elements_text", "json_typeof", "jsonb_typeof", "array_to_string", "array_agg", "lower", "upper", "round", "ceiling", "floor", "date_part", "row_to_json", "json_strip_nulls", "jsonb_strip_nulls"];
    switch (expr.op) {
      case ">":
      case "<":
      case ">=":
