...
module.exports = JsonqlCompiler = (function() {
  ...
  JsonqlCompiler.prototype.compileOpExpr = function(expr, aliases) {
    ...
    functions = ["avg", "min", "max", "sum", "count", "stdev", "stdevp", "var", "varp", "row_number", "left", "right", "substr", "lpad", "rpad", "width_bucket", "ntile", "coalesce", "to_json", "convert_to_decimal", "json_array_elements", "jsonb_array_elements_text", "array_to_string"];
    switch (expr.op) {
      case ">":
      case "<":
      case ">=":
