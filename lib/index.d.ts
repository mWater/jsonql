...
export declare type JsonQLQuery = JsonQLSelectQuery | JsonQLUnion | JsonQLUnionAll;
...
export declare type JsonQLExpr = JsonQLLiteral | JsonQLOp | JsonQLCase | JsonQLScalar | JsonQLField | JsonQLToken | null | number | string | boolean;
/** Literal value */
...
export declare type JsonQLFrom = JsonQLTableFrom | JsonQLJoinFrom | JsonQLSubqueryFrom | JsonQLSubexprFrom;
