...
describe("JsonqlCompiler", function() {
  ...
  it("compiles reused alias", function() {
    const expr = {"type":"scalar","expr":{"type":"field","tableAlias":"j1","column":"_id"},"from":{"type":"table","table":"entities.water_point","alias":"j1"},"where":{"type":"scalar","expr":{"type":"field","tableAlias":"j1","column":"_id"},"from":{"type":"table","table":"entities.water_point","alias":"j1"},"where":{"type":"op","op":"=","exprs":[{"type":"op","op":"coalesce","exprs":[{"type":"op","op":"#>>","exprs":[{"type":"field","tableAlias":"main","column":"data"},"{e75938878a034797a08969f847629931,value,code}"]},{"type":"op","op":"#>>","exprs":[{"type":"field","tableAlias":"main","column":"data"},"{e75938878a034797a08969f847629931,value}"]}]},{"type":"field","tableAlias":"j1","column":"code"}]}}};
  ...
  return describe("compiles expressions", function() {
    ...
    describe("case", function() {
      it("does input case", function() {
        return this.testExpr({ type: "case", input: this.a, cases: [{ when: this.b, then: this.c }]}, 
          "case ? when ? then ? end", [1, 2, 3]
          );
      });
      
      return it("does multiple case with else", function() {
        return this.testExpr({ type: "case", cases: [
    ...
    describe("ops", function() {
      ...
      it('and', function() {
        ...
        return this.testExpr({ type: "op", op: "and", exprs: [{ type: "op", op: "and", exprs: [] }, { type: "op", op: "and", exprs: [this.a] }] }, "?", [1]);
      });
      ...
      it('= any', function() {
        ...
        return this.testExpr({ type: "op", op: "=", modifier: "any", exprs: [this.a, arr] }, "(? = any(?))", [1, ["x", "y"]]);
      });
      ...
      it('between', function() {
        return this.testExpr({ type: "op", op: "between", exprs: [this.a, this.b, this.c] }, "(? between ? and ?)", [1, 2, 3]);
      });
      ...
      it("creates exists", function() {
        ...
        return this.testExpr({ type: "op", op: "exists", exprs:[
          query
      ...
      return it('at time zome', function() {
        return this.testExpr({ type: "op", op: "at time zone", exprs: [{ type: "op", op: "now", exprs: [] }, this.str] }, "(now() at time zone ?)", ["xyz"]);
      });
    });

    return describe("scalar", function() {
      it("simple scalar", function() {
        return this.testExpr({ type: "scalar", expr: this.a, from: { type: "table", table: "abc", alias: "abc1" } }, '(select ? from ABC as "a_abc1")', [1]);
      });
