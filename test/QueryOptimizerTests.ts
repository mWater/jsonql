...
function compare(actual, expected) {
  ...
  if (strActual !== strExpected) {
    for (
      let i = 0, end = Math.min(strActual.length, strExpected.length), asc = 0 <= end;
      asc ? i < end : i > end;
      asc ? i++ : i--
    ) {
...
describe("QueryOptimizer", function () {
  ...
  it("determines if expr is aggregate", function () {
    ...
    assert.isFalse(
      this.opt.isAggr({ type: "op", op: "+", exprs: [{ type: "field", tableAlias: "a", column: "a1" }, 2] })
    )
    return assert.isTrue(
      this.opt.isAggr({ type: "op", op: "sum", exprs: [{ type: "field", tableAlias: "a", column: "a1" }] })
    )
  })
        ...
        { type: "select", expr: { type: "field", tableAlias: "a", column: "a1" }, alias: "s1" },
        {
          ...
          expr: {
            ...
            where: {
              ...
              op: "=",
              exprs: [
                { type: "field", tableAlias: "b", column: "b2" },
                { type: "field", tableAlias: "a", column: "a2" }
              ]
            }
          },
          alias: "s2"
        ...
        query: {
          ...
          from: {
            ...
            on: {
              ...
              op: "=",
              exprs: [
                { type: "field", tableAlias: "opt0", column: "b2" },
                { type: "field", tableAlias: "a", column: "a2" }
              ]
            }
          },
      ...
      from: {
        ...
        query: {
          ...
          selects: [
            ...
            {
              type: "select",
              expr: { type: "op", op: "sum", exprs: [{ type: "field", tableAlias: "opt0", column: "b1" }] },
              alias: "expr"
            }
          ],
          from: {
            ...
            on: {
              ...
              exprs: [
                { type: "field", tableAlias: "opt0", column: "b2" },
                { type: "field", tableAlias: "opt1", column: "opt_a_a2" }
              ]
            }
          },
          groupBy: [1, 2, 3, 4]
    ...
    */
      ...
      where: {
        ...
        exprs: [
            ...
            exprs: [
              {
                ...
                where: {
                  ...
                  op: "=",
                  exprs: [
                    { type: "field", tableAlias: "c", column: "c2" },
                    { type: "field", tableAlias: "a", column: "a4" }
                  ]
                }
              },
          ...
          },
          {
            ...
            op: "=",
            exprs: [
              { type: "field", tableAlias: "a", column: "a5" },
              { type: "literal", value: 3 }
            ]
          }
        ]
    ...
    const inner1Query = {
      ...
      selects: [
        ...
        {
          type: "select",
          expr: { type: "op", op: "sum", exprs: [{ type: "field", tableAlias: "opt0", column: "c1" }] },
          alias: "expr"
        }
      ],
      from: {
        ...
        on: {
          ...
          op: "=",
          exprs: [
            { type: "field", tableAlias: "opt0", column: "c2" },
            { type: "field", tableAlias: "opt1", column: "opt_a_a4" }
          ]
        }
      },
      groupBy: [1, 2, 3, 4, 5, 6]
        ...
        { type: "select", expr: { type: "field", tableAlias: "opt2", column: "opt_a_a1" }, alias: "s1" },
        {
          ...
          expr: {
            ...
            where: {
              ...
              exprs: [
                { type: "field", tableAlias: "b", column: "b2" },
                { type: "field", tableAlias: "opt2", column: "opt_a_a2" }
              ]
            }
          },
          alias: "s2"
